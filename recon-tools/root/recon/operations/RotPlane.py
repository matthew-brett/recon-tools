...
class RotPlane (Operation):
    ...
    params = (Parameter(name="orient_target", type="str", default=None,
                        description="final orientation of the image, taken "\
                        "from ANALYZE orient codes. Can be: radiological, "\
                        "transverse, coronal, coronal_flipped, saggital, and "\
                        "saggital_flipped. Also can be recon_epi."),
              )
