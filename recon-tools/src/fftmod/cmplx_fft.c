...
PyObject *fftmod_fft1d(PyObject *self, PyObject *args) {
  ...
  int type, dir, len_xform, len_array, dim;
  PyTypeObject *pytype;
  PyArray_Descr *dtype;

  if(!PyArg_ParseTuple(args, "Oi", &op1, &dir)) {
...
PyObject *fftmod_fft2d(PyObject *self, PyObject *args) {
  PyObject *op1;
  PyArrayObject *ap1, *ret;
  int type, dir, xdim, ydim, len_array, dim;
  PyTypeObject *pytype;
  PyArray_Descr *dtype;
  if(!PyArg_ParseTuple(args, "Oi", &op1, &dir)) {
